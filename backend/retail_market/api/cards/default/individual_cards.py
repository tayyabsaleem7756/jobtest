...
PERSONAL_CARD = {
    ...
    "schema": [
        ...
        },
        {
            ...
            "disabled": False,
            "data": {
                "placeholder": "UK National Insurance Number"
            },
            "field_dependencies": [
                {
