...
import {
	IRequiredDocument,
	IUploadedDocument,
} from '../OpportunityOnboarding/documents_required'
import { IInvestmentAmount } from '../OpportunityOnboarding/criteriaResponse'
import { ToolTipText } from '../common/tooltips'
