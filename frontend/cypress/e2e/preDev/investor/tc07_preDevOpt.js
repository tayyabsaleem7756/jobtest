...
describe('Create Fund/ Eligibility Criteria/ Approval of Eligibility-4min', () => {
...
describe("Investor's - Find Fund and click on Apply Now Link", () => {
...
describe('KnowledgeableAdmin-Revision/ Approval', () => {
...
describe('Admin-Vehicle/ Master Class Selection/ Approval', () => {
...
describe('Investor-KYC/ AML Process/ Revisions/ Approval', () => {

    context("Investor-KYC/ AML Process ", () => {
    ...
    context('KYC/AML Approval From Financial Admin', {
        scrollBehavior: false
    }, () => {
...
describe('Investor Tax Form-New Investor/ Application Overview Verification', () => {
...
describe('Admin Document Revision Request/ Investor Upload Document Revision/ Admin Document Revision Request Verification ', () => {

    context("Admin Document Revision Request ", () => {
    ...
    context("Investor Upload Document Revision ", () => {
    ...
    context("Admin Document Revision Request Verification ", () => {
