export DOCKER_REPO_URL="391503469783.dkr.ecr.us-west-2.amazonaws.com/sidecar-public-marketplace-frontend"
...
export DOCKER_CONTEXT_PATH="frontend/public-marketplace"
