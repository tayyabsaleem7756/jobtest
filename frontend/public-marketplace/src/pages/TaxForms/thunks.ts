...
export const fetchAppRecord = createAsyncThunk<
	any,
	string,
	{ state: RootState }
...
export const fetchTaxDocumentsList = createAsyncThunk<
	any,
	string,
	{ state: RootState }
...
export const fetchTaxDetails = createAsyncThunk(
	'taxModule/fetchTaxDetails',
	async (record_id: string, thunkAPI) => {
		try {
...
export const createTaxWorkflow = createAsyncThunk(
	'taxModule/createTaxWorkflow',
	async (external_id: any, thunkAPI) => {
		try {
